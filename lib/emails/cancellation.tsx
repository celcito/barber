      ...
      <Body style={styles.main}>
        <Container style={styles.container}>
          <Section style={styles.header}>
            ...
            <Text style={styles.headerSub}>Agendamento Cancelado</Text>
          </Section>
          ...
          <Section style={styles.body}>
            ...
            <Text style={{ ...styles.greeting, fontSize: "14px", color: "#9a8f80" }}>
              Se desejar, você pode fazer um novo agendamento quando preferir.
            </Text>
          </Section>
          ...
          <Section style={styles.footer}>
            ...
            <Text style={styles.footerText}>Agradecemos pela compreensão.</Text>
          </Section>
        </Container>
      </Body>
    </Html>
