      ...
      <Body style={styles.main}>
        <Container style={styles.container}>
          <Section style={styles.header}>
            ...
            <Text style={styles.headerSub}>Agendamento Confirmado</Text>
          </Section>

          <Section style={styles.body}>
            <Text style={styles.greeting}>Olá {clienteNome},</Text>
            <Text style={styles.greeting}>
              Seu agendamento foi confirmado com sucesso! Aqui estão os
              detalhes:
            </Text>
            ...
            <Section style={styles.card}>
              ...
              <div style={{ ...styles.cardRow, borderBottom: "none" }}>
                ...
                <Text style={styles.cardValue}>{salaoNome}</Text>
              </div>
            </Section>
          </Section>
